/* Evgeny Zajcev, [2/14/22 2:15 PM] */
/* либо делай блокирующий mmap при аллокации, либо падай в корку если sbrk не сработал */

/* Evgeny Zajcev, [2/14/22 2:16 PM] */
/* а если ты сделал неблокирующий mmap и какие-то там эксепшоны кидаешь, то это плохой код */
